...
class TransferEntityAssemblerTest extends TestCase
{
    public function testCanAssembleDtoWithRawData(): void
    {
        ...
        self::assertSame($data['source'], $dto->source);
        self::assertSame($data['target'], $dto->target);
        self::assertSame($data['type'], $dto->type);
        self::assertSame($data['entityDescriber'], $dto->entityDescriber);
    }
    ...
    public function testCanAssembleDtoWithOrganizationHelperMethods(): void
    {
        ...
        self::assertSame('organization:f12edb4c-fc02-494e-ac39-74f7ec5bbaaa', $dto->source);
        self::assertSame('organization:f9243a32-6229-4e88-951f-4cb3f61cc4d8', $dto->target);
        self::assertSame($data['type'], $dto->type);
        self::assertSame($data['entityDescriber'], $dto->entityDescriber);
    }
    ...
    public function testCanAssembleDtoWithUserHelperMethods(): void
    {
        ...
        self::assertSame('user:foobar', $dto->source);
        self::assertSame('user:barbaz', $dto->target);
        self::assertSame($data['type'], $dto->type);
        self::assertSame($data['entityDescriber'], $dto->entityDescriber);
    }
}
